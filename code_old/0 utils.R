...
get_params<-function(params, nt){
  ...
  for (t in 1:nt) {
    logit_t_mn <-mu_mn+ep_mn_t[t]#+beta1_mn*mat+beta2_mn*tap
    logit_t_mx <-mu_mx+ep_mx_t[t]#+beta1_mx*mat+beta2_mx*tap
    logit_t_sos <-mu_sos+ep_sos_t[t]#+beta1_sos*mat+beta2_sos*tap
    logit_t_eos <-mu_eos+ep_eos_t[t]#+beta1_eos*mat+beta2_eos*tap
    logit_t_rsp <-mu_rsp+ep_rsp_t[t]#+beta1_rsp*mat+beta2_rsp*tap
    logit_t_rau <-mu_rau+ep_rau_t[t]#+beta1_rau*mat+beta2_rau*tap
    logit_t_rsu <-mu_rsu+ep_rsu_t[t]#+beta1_rsu*mat+beta2_rsu*tap
