...
# Fig. S8
```{r fig-NAB threshold, fig.height=10*0.618, fig.width=10, echo = FALSE, message=FALSE, warning=FALSE, process=FALSE, fig.cap="Figure S8. Summary of results when using NAB threshold, 6,500 spores m–3."}
