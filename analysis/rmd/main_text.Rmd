...
df_ana <- read_rds(str_c(.path$dat_process, "dat_ana_as4605.rds"))
```
...
p_metrics
# ggsave(
#   paste0(.path$out_fig, "preprint/Figure_1.png"),
#   plot = p_metrics,
#   height = 11, width = 11)
```
...
p_calendar
# ggsave(
#   paste0(.path$out_fig, "preprint/Figure_2.png"),
#   plot = p_calendar,
...
p_trend_map_TS_SAS
# ggsave(
#   paste0(.path$out_fig, "preprint/Figure_3.png"),
...
# ggsave(
#   paste0(.path$out_fig, "preprint/Figure_4.png"),
...
p_coef
# ggsave(
#   paste0(.path$out_fig, "preprint/Figure_5.png"),
#   plot = p_coef,
