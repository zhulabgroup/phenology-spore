...
df_analysis <- right_join(df_daymet_annual, df_metrics_long, by = c("lat", "lon", "station", "city", "state", "country", "id", "n", "offset", "year_new"))
```

# fit mlr on anomalies
```{r}
source("calc_anom.R")
df_test <- calc_anom(df_raw = df_analysis, metric = "SOS", pct = 0.8)
df_test
```
