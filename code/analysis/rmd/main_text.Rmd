...
source("~/Github/spore_phenology/code/analysis/functions/plot_metrics.R")
p_metrics
```
...
source("~/Github/spore_phenology/code/analysis/functions/plot_calendar_samples.R")
p_calendar
```
...
source("~/Github/spore_phenology/code/analysis/functions/plot_trend_map_TS_SAS.R")
p_trend_map_TS_SAS
```
...
source("~/Github/spore_phenology/code/analysis/functions/plot_trend_ctnt_pred_composite.R")
