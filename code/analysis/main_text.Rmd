...
```{r fig-trend-station, fig.height=8*0.618, fig.width=8, message=FALSE, warning=FALSE, process=FALSE}
source("~/Github/spore_phenology/code/analysis/plot_trend_station_map_TS.R")
p_trend_map_TS
```
