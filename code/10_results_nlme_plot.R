...
nlme_integral <- lme(integral ~ year_new, data = df_integral, random = ~ year_new | n)
summary(nlme_integral)
nlme_sos <- lme(sos ~ year_new, data = df_season, random = ~ year_new | n)
summary(nlme_sos)
nlme_eos <- lme(eos ~ year_new, data = df_season, random = ~ year_new | n)
summary(nlme_eos)
nlme_los <- lme(los ~ year_new, data = df_season, random = ~ year_new | n)
summary(nlme_los)
